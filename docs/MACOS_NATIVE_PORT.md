# AI Sales OS v5.10.2 原生 macOS 交付说明
...
macOS 版以 GitHub `main` 的 Windows v5.10.2 为功能基线，包含 8 个主模块：
...
```powershell
./scripts/build-macos-preview.ps1 -Version 5.10.2 -Architecture AppleSilicon
```

同时构建两种架构：

```powershell
./scripts/build-macos-preview.ps1 -Version 5.10.2 -Architecture Both
```
...
```text
dist/installers/AI Sales OS macOS Apple-Silicon Chinese v5.10.2.dmg
